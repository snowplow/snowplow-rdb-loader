...
import com.snowplowanalytics.snowplow.rdbloader.core.discovery.{DataDiscovery, DiscoveryFailure}
...
package object core {
  ...
  /**
    ...
    */
  def sequenceInF[F[_]: Functor, G[_]: Traverse, H[_]: Applicative, J[_], A](
    f: F[G[H[A]]],
    ff: H[G[A]] => J[G[A]]
  ): F[J[G[A]]] =
