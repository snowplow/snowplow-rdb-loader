  ...
  "fromString" should {
    ...
    "be able to infer host" in {
      val exampleSnowflake = StorageTarget.Snowflake(
        ...
        jdbcHost = None)
      exampleSnowflake.host mustEqual  "acme.snowflakecomputing.com"
      exampleSnowflake.copy(jdbcHost = "override".some).host mustEqual  "override"
      exampleSnowflake.copy(snowflakeRegion = "us-east-1".some).host mustEqual  "acme.us-east-1.snowflakecomputing.com"
      exampleSnowflake.copy(snowflakeRegion = "us-east-1-gov".some).host mustEqual  "acme.us-east-1-gov.aws.snowflakecomputing.com"
    }
  }
}
