...
import com.snowplowanalytics.snowplow.rdbloader.common.config.Config.Shredder.{ Deduplication => Config }
...
object Deduplication {
   ...
   * synthetic deuplicate UUIDs (in case of broadcast deduplication) or
