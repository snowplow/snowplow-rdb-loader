...
import com.snowplowanalytics.snowplow.loader.redshift.loading.EventsTable
...
object Statement {
  ...
  // Manifest
  case class ManifestAdd(schema: String, message: LoaderMessage.ManifestItem) extends Statement {
    def toFragment: Fragment = {
