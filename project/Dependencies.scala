...
object Dependencies {
  ...
  object V {
    ...
    val catsEffLaws = "2.2.0"
  }

  val resolutionRepos = Seq(
    // Redshift native driver
    "redshift"
      .at("http://redshift-maven-repository.s3-website-us-east-1.amazonaws.com/release")
  ...
  val catsEffLaws      = "org.typelevel"  %% "cats-effect-laws"           % V.catsEffLaws % Test
